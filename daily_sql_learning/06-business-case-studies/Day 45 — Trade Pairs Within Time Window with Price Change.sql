...
/*
-- Find all couples of trade for some stock that happened in the range of 10 seconds &
-- Having price difference more than 10%
-- Output result should also list the percentage of price difference between the two trades.
*/
