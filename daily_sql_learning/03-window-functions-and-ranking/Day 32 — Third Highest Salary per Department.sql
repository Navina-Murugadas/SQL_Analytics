...
-- Find details of employees with 3rd highest salary in each department.
-- In case of less than 3 employees in a department then return employee details with lowest salary in that department.
